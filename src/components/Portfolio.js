                  ...
                  <div className="list_inner w-full h-auto clear-both float-left relative overflow-hidden">
                    <div className="image relative">
                      ...
                      <div
                        ...
                        data-img-url="assets/img/portfolio/BlinedByFusion.jpeg"
                      />
                      ...
                      <a
                        ...
                        href="assets/img/portfolio/BlinedByFusion.jpeg"
                      />
                    </div>
                  </div>
                </li>
                <li className="image mb-[50px] w-1/2 float-left pl-[50px] item__">
                  <div className="list_inner w-full h-auto clear-both float-left relative overflow-hidden">
                    <div className="image relative">
                      ...
                      <a
                        className="cavani_tm_full_link zoom"
                        href="assets/img/portfolio/TalAlhasani-Opulance.jpeg"
                      />
                    </div>
                  </div>
                </li>
                  ...
                  <div className="list_inner w-full h-auto clear-both float-left relative overflow-hidden">
                    <div className="image relative">
                      ...
                      <div className="details">
                        ...
                        <span className="text-[14px]">Competition</span>
                      </div>
                      <a
                        className="cavani_tm_full_link zoom"
                        href="assets/img/portfolio/Opulance.jpeg"
                      />
                    </div>
                  </div>
                </li>
                <li className="image mb-[50px] w-1/2 float-left pl-[50px] item__">
                  <div className="list_inner w-full h-auto clear-both float-left relative overflow-hidden">
                    <div className="image relative">
                      ...
                      <a
                        className="cavani_tm_full_link zoom"
                        href="assets/img/portfolio/Tangled.jpeg"
                      />
                    </div>
                  </div>
                </li>
